...
export default class SettingsDialog extends OverlayDialog {
  ...
  buildDOM() {
    ...
    settingsWrapperDOM.classList.add('h5p-gamifier-settings-wrapper');
    ...
    volumeMusicLabel.classList.add('h5p-gamifier-settings-label');
    ...
    volumeSFXLabel.classList.add('h5p-gamifier-settings-label');
