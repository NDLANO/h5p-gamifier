...
export default class OverlayDialog {
  ...
  constructor(params = {}, callbacks = {}) {
    ...
    this.dom.classList.add('h5p-gamifier-overlay-dialog');
    ...
    this.contentContainer.classList.add(
      'h5p-gamifier-overlay-dialog-content-container',
    );
    ...
    this.content.classList.add('h5p-gamifier-overlay-dialog-content');
    this.contentContainer.append(this.content);

    // Close button
    this.buttonClose = document.createElement('button');
    this.buttonClose.classList.add('h5p-gamifier-overlay-dialog-button-close');
    ...
    headline.classList.add('h5p-gamifier-overlay-dialog-headline');
    this.content.append(headline);

    this.headlineText = document.createElement('div');
    this.headlineText.classList.add('h5p-gamifier-overlay-dialog-headline-text');
    headline.append(this.headlineText);

    // H5P instance
    this.instanceContainer = document.createElement('div');
    this.instanceContainer.classList.add('h5p-gamifier-overlay-dialog-instance-container');
  ...
  show(params = {}) {
    ...
    window.requestAnimationFrame(() => {
      ...
      const animate = params.animate ?? this.params.animate ?? true;
      if (animate) {
  ...
  animate(animationName, callback) {
    ...
    if (this.params.animate === false) {
      return; // Animation deactivated for this instance
    }
